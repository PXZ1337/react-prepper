...
const CategoryGridItem = (props: CategoryGridItemProps) => {
    ...
    return <GridItem onClickHandler={onClickHandler.bind(null, props.id.toString())} classNames={[itemClass]}>
        <div className={classes.stock}>{formatUnit(props.stock, props.unit, false)} / {formatUnit(props.goal, props.unit)}</div>
